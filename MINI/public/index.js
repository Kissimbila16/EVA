...
const { extractEntities } = require("./core/entities");
const { analyzeSentiment } = require("./core/sentiment");
const knowledgeBase = require("./core/knowledgeBase");
const { updateContext, getContext, uuidv4 } = require("./core/context");
const { trainPipeline, saveClassifier, loadClassifier } = require("./training/pipeline");
